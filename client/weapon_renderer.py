...
class ScattergunRenderer(WeaponRenderer):
    ...
    def __init__(self):
        self.depth = 1
        self.weaponsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/scatterguns/0.png"))
        self.firingsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/scatterguns/2.png"))
...
class FlamethrowerRenderer(WeaponRenderer):
    ...
    def __init__(self):
        self.depth = 1
        self.weaponsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/flamethrowers/0.png"))
        self.firingsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/flamethrowers/2.png"))
...
class RocketlauncherRenderer(WeaponRenderer):
    ...
    def __init__(self):
        self.depth = 1
        self.weaponsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/rocketlaunchers/0.png"))
        self.firingsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/rocketlaunchers/2.png"))
...
class MinigunRenderer(WeaponRenderer):
    ...
    def __init__(self):
        self.depth = 1
        self.weaponsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/miniguns/0.png"))
        self.firingsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/miniguns/2.png"))
...
class MinegunRenderer(WeaponRenderer):
    ...
    def __init__(self):
        self.depth = 1
        self.weaponsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/mineguns/0.png"))
        self.firingsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/mineguns/2.png"))
...
class MedigunRenderer(WeaponRenderer):
    ...
    def __init__(self):
        self.depth = 1
        self.weaponsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/mediguns/0.png"))
        self.firingsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/mediguns/0.png"))
...
class ShotgunRenderer(WeaponRenderer):
    ...
    def __init__(self):
        self.depth = 1
        self.weaponsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/shotguns/0.png"))
        self.firingsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/shotguns/2.png"))
...
class RevolverRenderer(WeaponRenderer):
    ...
    def __init__(self):
        self.depth = 1
        self.weaponsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/revolver2s/0.png"))
        self.firingsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/revolver2s/2.png"))
...
class BladeRenderer(WeaponRenderer):
    ...
    def __init__(self):
        self.depth = 1
        self.weaponsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/blades/0.png"))
        self.firingsprite = s.Sprite(function.load_texture(constants.SPRITE_FOLDER + "weapons/blades/2.png"))
