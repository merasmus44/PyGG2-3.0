...
class BuildingSentryRenderer(object):
    ...
    def render(self, renderer, game, state, sentry):
        ...
        sprite_offset = (-8, -20)
        sprite = self.sprites[min(int(sentry.animation_frame), 9)]  # TODO, get rid of this min and figure out how to
        # cap an image index

        if sentry.flip is True:
