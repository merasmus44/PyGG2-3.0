...
class GameRenderer(object):
    def __init__(self, client):
        ...
        self.maprenderer = map_renderer.MapRenderer(self, client.game.map.mapname)
        self.healthhud = None
        self.overlayblits = []
        ...
        self.renderers = {
            ...
            engine.character.Demoman: character_renderer.DemomanRenderer(),
            ...
            engine.projectile.Mine: projectile_renderer.MineRenderer(),
